  ...
  return {
    ...
    controller: function($scope, $element, $attrs){
      ...
      $scope.$watch('searchParam', function(newValue, oldValue){
        ...
        if($scope.onType)
            //This is odd, but necessary because the scope inheritance is altered when using autocomplete directive in
            //formly
          $scope.$parent.$parent.$parent.$parent[$scope.onType]($scope.searchParam);
      });
