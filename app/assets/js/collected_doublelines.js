    ...
    var stopCounter = false, topDown = false, controlsHidden = false, viewer = null, currentZoomLvl = 0, controlHover = false, navWaitTime = 6000, preventControls = false, inputMarked = false;
...
/*      event.preventDefault();
    ...
    ===============================================*/
        ...
        $(this).find('.linkDiv').setSelectionRange(0,9999);
    ...
    function showSingleImage(imageSrc, height, width){
        ...
        if ($('#map').length !== 0) {
          ...
          removeViewers();
            ...
            var maxheight = (parseInt(height) * 2), maxwidth = (parseInt(width) * 2);
            ...
            // var southW = map.unproject([0, maxheight], map.getMaxZoom()-1);

            // var northE = map.unproject([maxwidth, 0], map.getMaxZoom()-1);



            var bounds = new L.LatLngBounds(southWest, northEast);

            // var oBounds = new L.LatLngBounds(southW, northE);
