...
(function ($) {
	...
	LocationChanger.prototype.createHolders = function () {
		...
		this.$contentHol.append($('<div />')
			.addClass('lhp_giv_hitarea')
			.css({position : 'absolute', 'z-index' : '2', width : '100%', height : '100%'})
		);
	...
	LocationChanger.prototype.start = function () {
		...
		if(this.isTouchDev) {
			...
			//$(".lhp_giv_content", _this.$contentHol).css({'z-index':'3', 'position':'absolute'});
			//_this.$contentHol.off("pinch", _this.pinchHandler).on("pinch", ".lhp_giv_content", {'_this' : _this}, _this.pinchHandler);
			$(".lhp_giv_hitarea", this.$contentHol).on("pinch", {'_this' : this}, this.pinchHandler);
	...
	LocationChanger.prototype.mousedownHandler = function (e) {
		if($(e.target).hasClass('lhp_giv_content') || $(e.target).hasClass('lhp_giv_hitarea') || $(e.target).hasClass('tile')) {
	...
	Popup.prototype.ini = function () {
		...
		//this.$p.bind('mousedown.lhpGIV touchmove.lhpGIV mouseenter.lhpGIV mouseleave.lhpGIV mousewheel.lhpGIV', function(e){
